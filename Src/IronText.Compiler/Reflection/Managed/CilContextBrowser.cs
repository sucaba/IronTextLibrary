...
namespace IronText.Reflection.Managed
{
    public static class CilContextProviderExtensions
    {
        ...
        {
            return new CilContextProviderEx(provider).GetGetterPath(type);
        }

        public static IEnumerable<Type> GetAllContextTypes(this CilContextProvider provider)
        {
            return new CilContextProviderEx(provider).GetAllContextTypes();
        }

        class CilContextProviderEx
        {
            private readonly Type fromType;

            public CilContextProviderEx(CilContextProvider provider)
            {
                this.fromType = provider.ProviderType;
            }
