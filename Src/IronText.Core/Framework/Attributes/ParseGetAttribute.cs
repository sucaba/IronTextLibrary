...
namespace IronText.Framework
{
    ...
    public class ParseGetAttribute : RuleMethodAttribute
    {
        public ParseGetAttribute(params string[] keywordMask) 
        {
        ...
        protected override MethodInfo Method
        {
            get
            {
                ...
                if (getter == null)
                {
                    var msg = string.Format("Property '{0}' should have getter method.", property);
